...
else
{
	...
	if ($WPS_STATE == 1)
	{
		$SSID = query($phyrp."/media/wps/registrar/preferred/ssid");
		if ($SSID == "") $SSID = query($wifi."/ssid");
		$auth = "WPAPSK";
		$wepmode = "TKIP";
	}
}
...
if($PINDISABLED == "1" && $WPS_STATE == "2")	$CONFIGMETHODS=0x0080;
else											$CONFIGMETHODS=0x0186;
