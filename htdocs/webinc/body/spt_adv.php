	...
	<dl>
		...
		<dd><?echo i18n("You are hosting a Web Server on a PC that has LAN IP Address of 192.168.0.50 and your ISP is blocking Port 80.");?>
			<ol>
				...
				<li><?echo i18n("Tick the checkbox at the left of this entry");?></li>
				<li><?echo i18n("Click <span class='button_ref'>Save Settings</span> to take effect");?></li>
			</ol>
	...
	<dl>
		...
		<dd>
			<dl>
				...
				<dd><?
					echo i18n("Select the protocol used by the service. The common choices -- UDP, TCP, and both UDP and TCP -- can be selected from the drop-down menu.");
				?></dd>
		...
		<dt><strong><?echo i18n("Virtual Servers List");?></strong></dt>
	...
	<dl>
		...
		<dd>
			<dl>
				...
				<dd><?
					echo i18n('Assign a meaningful name to the port forwarding, for example Web Server. Several well-known types of port forwarding are available from the "Application Name" drop-down menu. Selecting one of these entries fills some of the remaining parameters with standard values for that type of server.');
				?></dd>
...
<div class="blackbox">
	...
	?></p>
	<p><?
		echo i18n('Select "Turn MAC Filtering ON and ALLOW computers listed to access the network" if you only want selected computers to have network access and all other computers not to have network access.');
	?></p>
	<p><?
		echo i18n('Select "Turn MAC Filtering ON and DENY computers listed to access the network" if you want all computers to have network access except those computers in the list.');
	?></p>
	<dl>
...
<div class="blackbox">
	...
	<dl>
		...
		?></dd>
		<dt><strong><?echo i18n("WAN Ping");?></strong></dt>
		<dd><?
			echo i18n("When you Enable WAN Ping respond, you are causing the public WAN (Wide Area Network) IP address on the device to respond to ping commands sent by Internet users. Pinging public WAN IP addresses is a common method used by hackers to test whether your WAN IP address is valid.");
		?></dd>
...
<div class="blackbox" <?if ($FEATURE_NOCALLMGR !="0") echo ' style="display:none;"';?>>
	...
	<dl>
		...
		<dt><strong><?echo i18n("Hotkey");?></strong></dt>
		<dd>
			<dl>
				<dt><strong><?echo i18n("*50*666");?></strong></dt>
				<dd><?echo i18n("Allows you to Disable the Caller ID Delivery.");?></dd>
				<dt><strong><?echo i18n("*51*666");?></strong></dt>
				<dd><?echo i18n("Allows you to Enable the Caller ID Delivery.");?></dd>
				<dt><strong><?echo i18n("*40*666");?></strong></dt>
                                <dd><?echo i18n("Allows you to Disable the Call Waiting.");?></dd>
				<dt><strong><?echo i18n("*41*666");?></strong></dt>
                                <dd><?echo i18n("Allows you to Enable the Call Waiting.");?></dd>
				<dt><strong><?echo i18n("*30*666");?></strong></dt>
                                <dd><?echo i18n("Allows you to Disable the Call Forwarding.");?></dd>
				<dt><strong><?echo i18n("*31*666*<phone number>");?></strong></dt>
                                <dd><?echo i18n("Allows you to Set the Call Forwarding Unconditional.");?></dd>
				<dt><strong><?echo i18n("*32*666*<phone number>:<sec>");?></strong></dt>
                                <dd><?echo i18n("Allows you to Set the Call Forwarding No Answer.");?></dd>
				<dt><strong><?echo i18n("*33*666*<phone number>");?></strong></dt>
                                <dd><?echo i18n("Allows you to Set the Call Forwarding Busy.");?></dd>
				<dt><strong><?echo i18n("*34*666*<phone number>");?></strong></dt>
                                <dd><?echo i18n("Allows you to Set the Call Forwarding Not Reachable.");?></dd>
				<dt><strong><?echo i18n("*99*");?></strong></dt>
                                <dd><?echo i18n("Allows you to Save changes.");?></dd>
			</dl>
		</dd>
...
<div class="blackbox" <?if ($FEATURE_NOIPV6 == "1") echo ' style="display:none;"';?>>
	...
	<dd><?
		echo i18n("For each rule you can create a name and control the direction of traffic. You can also allow or deny a ra
nge of IP Addresses, the protocol and a port range.In order to apply a schedule to a firewall rule, your must first define a schedul
e on the Tools -> Schedules page");
	?>
	</dd>
</div>
