...
<div class="blackbox">
	...
	<ul>
		...
		<?
			if ($FEATURE_NOIPV6 == "0")
			{
				echo '<li><a href="./spt_setup.php#IPv6">'.i18n("IPv6").'</a></li>\n';
			}
		?>
	</ul>
</div>
<div class="blackbox">
	...
	<ul>
		...
		<?
			if ($FEATURE_NOIPV6 == "0") 
			{
				echo '<li><a href="./spt_adv.php#IPv6Firewall">'.i18n("IPv6 Firewall").'</a></li>\n';
				echo '<li><a href="./spt_adv.php#Routing">'.i18n("IPv6 Routing").'</a></li>\n';
			}
		?>
	</ul>
</div>
...
<div class="blackbox">
	...
	<ul>
		...
		<?if ($FEATURE_NOIPV6 =="0") echo '<li><a href="./spt_status.php#IPv6">'.i18n("IPv6").'</a></li>\n';?>
		<?if ($FEATURE_NOIPV6 =="0") echo '<li><a href="./spt_status.php#Routing">'.i18n("IPv6 Routing").'</a></li>\n';?>
	</ul>
</div>
