...
<div class="blackbox">
	...
	<div class="textinput">
		<span class="name"><?echo i18n("Wi-Fi Protected Status");?></span>
		<span class="delimiter">:</span>
		<span class="value"><span id="st_wps"></span>&nbsp;/&nbsp;<span id="st_config"></span></span>
	</div>
	<div class="textinput">
		<span class="name"><?echo i18n("Disable WPS-PIN Method");?></span>
		<span class="delimiter">:</span>
		<span class="value"><input id="lock_security" type="checkbox" onClick=""/></span>
	</div>
	<div class="textinput">
