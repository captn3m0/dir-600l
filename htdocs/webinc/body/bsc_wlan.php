...
?>			</select>
	...
	<div class="textinput">
		...
		<span class="value">
			<select id="wlan_mode" onChange="PAGE.OnChangeWLMode();">
				...
				<option value="bg"><?echo i18n("802.11 Mixed(g/b)");?></option>
				<option value="bgn"><?echo i18n("802.11 Mixed(n/g/b)");?></option>
			</select>
		</span>
	</div>
	<div class="textinput">
	...
	<div class="textinput" style="display:none;">
		<span class="name"><?echo i18n("HT 20/40 Coexist");?></span>
		<span class="delimiter">:</span>
		<span class="value">
			<input id="en_bwcoex" type="checkbox" />
