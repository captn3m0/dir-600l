...
<div class="blackbox">
	...
	<div class="textinput">
                <span class="name"><?echo i18n("Time Format");?></span>
                <span class="delimiter">:</span>
                <span class="value">
			<select id="schtimeformat" onchange="PAGE.OnChangeFormat();">
                                <option value="24"><?echo i18n("24-hour");?></option>
                                <option value="12"><?echo i18n("12-hour");?></option>
                        </select>
                </span>
        </div>
	<div class="textinput">
