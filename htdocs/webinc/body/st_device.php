...
<div class="blackbox">
	...
	<div class="textinput">
		<span class="name"><?echo i18n("Wireless Radio");?></span>
		<span class="delimiter">:</span>
		<span class="value" id="st_wireless_radio_2"></span>
	</div>
	<div class="textinput">
		<span class="name"><?echo i18n("MAC Address");?></span>
		<span class="delimiter">:</span>
	...
	<div class="textinput">
		<span class="name"><?echo i18n("802.11 Mode");?></span>
		<span class="delimiter">:</span>
		<span class="value" id="st_80211mode_2"></span>
	</div>
	<div class="textinput">
		<span class="name"><?echo i18n("Channel Width");?></span>
		<span class="delimiter">:</span>
		<span class="value" id="st_Channel_Width_2"></span>
	</div>
	<div class="textinput">
		<span class="name"><?echo i18n("Channel");?></span>
		<span class="delimiter">:</span>
		<span class="value" id="st_Channel_2"></span>
	</div>
	<div class="textinput">
		<span class="name"><?echo i18n("Network Name (SSID)");?></span>
		<span class="delimiter">:</span>
		<span class="value" id="st_SSID_2"></span>
	</div>
	<div class="textinput">
		<span class="name"><?echo i18n("Wi-Fi Protected Setup");?></span>
		<span class="delimiter">:</span>
		<span class="value" id="st_WPS_status_2"></span>
	</div>
	<div class="textinput">
		<span class="name"><?echo i18n("Security");?></span>
		<span class="delimiter">:</span>
		<span class="value" id="st_security_2"></span>
	</div>
	<div class="gap"></div>
</div>	
<?	
