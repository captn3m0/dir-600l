...
Page.prototype =
{
	...
	Initial: function()
	{
		...
		OBJ("ssid").innerHTML = XG(this.wifip+"/ssid");
		switch (XG(this.wifip+"/authtype"))
		{
		case "WPA+2PSK":
			OBJ("security").innerHTML = "<?echo i18n("Auto")." (".i18n("WPA or WPA2").") - ".i18n("Personal");?>";
			OBJ("cipher").innerHTML = CipherTypeParse(XG(this.wifip+"/encrtype"));
			OBJ("pskkey").innerHTML = XG(this.wifip+"/nwkey/psk/key");
			OBJ("st_cipher").style.display = "block";
			OBJ("st_pskkey").style.display = "block";
			break;
		case "WPA+2":
			OBJ("security").innerHTML = "<?echo i18n("Auto")." (".i18n("WPA or WPA2").") - ".i18n("Enterprise");?>";
			OBJ("cipher").innerHTML = CipherTypeParse(XG(this.wifip+"/encrtype"));
			OBJ("st_cipher").style.display = "block";
			this.en_wps = false;
			DisableWPS();
			break;
		case "SHARED":
			OBJ("security").innerHTML = "<?echo i18n("WEP")." - ".i18n("SHARED");?>";
			this.en_wps = false;
			DisableWPS();
		case "OPEN":
			if (XG(this.wifip+"/encrtype")=="WEP")
			{
				...
				OBJ("security").innerHTML = "<?echo i18n("WEP")." - ".i18n("OPEN");?>";
				OBJ("wepkey").innerHTML = key_no + ": " + XG(this.wifip+"/nwkey/wep/key:"+key_no);
				OBJ("st_wep").style.display = "block";
			}
			else
			{
				OBJ("security").innerHTML = "<?echo i18n("None");?>";
			}
		}
