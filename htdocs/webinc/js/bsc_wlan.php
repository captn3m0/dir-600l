...
Page.prototype =
{
	...
	Initial: function()
	{
		...
		OBJ("en_bwcoex").checked = (XG(this.phyinf+"/media/dot11n/bw2040coexist")=="0")? false : true;
	...
	SaveXML: function()
	{
		...
		XS(this.phyinf+"/media/dot11n/bw2040coexist",       SetBNode(OBJ("en_bwcoex").checked));
	...
	OnClickEnWLAN: function()
	{
		...
		if (OBJ("en_wifi").checked)
		{
			...
			OBJ("en_bwcoex").disabled = ((OBJ("bw").value!="20")? false : true);
			OBJ("wlan_mode").disabled	= false;
		...
		else
		{
			...
			OBJ("en_bwcoex").disabled = true;
			OBJ("wlan_mode").disabled	= true;
	...
	OnChangeBW: function()
	{
		...
		if(OBJ("bw").value==="20")	OBJ("en_bwcoex").disabled = true;
		else						OBJ("en_bwcoex").disabled = false;
