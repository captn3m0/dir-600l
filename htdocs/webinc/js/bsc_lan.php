	...
	OnClickDHCPSvr: function()
	{
		if (OBJ("dhcpsvr").checked && this.rgmode)
		{
			...
			for (var i=1; i <= <?=$DHCP_MAX_COUNT?>; i++)
			{
				...
				OBJ("desc_"+i).disabled = false;
				OBJ("ip_"+i).disabled = false;
				OBJ("mac_"+i).disabled = false;
				OBJ("bu_"+i).disabled = false;
				OBJ("pc_"+i).disabled = false;
			}
		}
		else
		{
			...
			for (var i=1; i <= <?=$DHCP_MAX_COUNT?>; i++)
			{
				...
				OBJ("desc_"+i).disabled = true;
				OBJ("ip_"+i).disabled = true;
				OBJ("mac_"+i).disabled = true;
				OBJ("bu_"+i).disabled = true;
				OBJ("pc_"+i).disabled = true;
			}
		}
	},
