...
function wifi_profile_setcfg($from, $to)
{
	...
	$configured_to	 = query($to."/wps/configured");
	$configured_from = query("wps/configured");
	$locksecurity	 = query("wps/locksecurity");
	set($to."/wps/configured",				$configured_from);
	//if ($configured_to == "0" && $configured_from == "1")
	//	set($to."/wps/locksecurity",		"1");
	//else 
	if ($locksecurity == "")
		set($to."/wps/locksecurity",		$configured_from);
	else
		set($to."/wps/locksecurity",		$locksecurity);
	if(query("acl/policy") != "")
	{
