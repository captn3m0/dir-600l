...
get_by_id("wz_save_b").value = sw("txtWizardEasyStepEnd7");	
...
<p class="box_msg" style="display:block"><font color="#0000FF"><SCRIPT language=javascript type=text/javascript>ddw("txtWizardEasyStepPressStore1");</SCRIPT></font></p>
		...
		<br>
		<table align="center" width="600" style="display:none">
