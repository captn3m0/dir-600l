...
if(mf.wan_l2tp_server.value == "0.0.0.0" || server_is_ipv4 && (mf.wan_l2tp_server.value == lan_ip_str) 
...
<input type="text" id="wan_l2tp_server" size="20" maxlength="128" value="<% getIndexInfo("l2tpServerIp"); %>" name="config.wan_l2tp_server"/>
</p><p> 
